...
cd ~/project_repo/mountjulietcafe.com/
...
cp -r ~/project_repo/mountjulietcafe.com/* ~/public_html/
...
echo "Done running permissions script. Check mjcafe site to verify changes."
